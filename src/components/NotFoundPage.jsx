...
const NotFoundPage = () => {
  const navigate = useNavigate();   //Declare first, can't be used directly
  return (
    <div>
      <div
        ...
        <div className="container">
          <div className="row">
            <div className="col-sm-8 offset-sm-2 text-gray-50 text-center -mt-52">
              ...
              <a className="bg-green-400  px-5 py-3 text-sm shadow-sm font-medium tracking-wider text-gray-50 rounded-full hover:shadow-lg" onClick={()=>navigate('/Home')}>
                Go to Home
              </a>
            </div>
          </div>
